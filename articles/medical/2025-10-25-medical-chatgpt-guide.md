...
2025年5月28日、厚生労働省は「医療情報システムの安全管理に関するガイドライン」のQ&Aを改定し、新たにQ-26を追加しました。この改定は、医療現場での生成AI使用に大きな影響を与えています。

改定の要点は、電子カルテの医療情報は原則として国内サーバーに保存する必要があり、生成AIを医療情報の入力に使用できるのは「学習目的で保存されない」場合に限られるというものです。つまり、完全に禁止されているわけではなく、厳格な条件を満たせば使用可能なのです。
...
ChatGPTの診断能力について、いくつかの研究が発表されています。その中でも注目すべきは、海外の大学による研究で、ChatGPTが救急患者を医師と同程度の正確性で診断できることが示されたものです。

この研究では、救急外来を受診した患者の症状をChatGPTに入力し、診断を求めたところ、医師の診断と高い一致率を示しました。特に一般的な疾患（感染症、消化器疾患、循環器疾患など）では、診断精度が高かったとされています。
...
2025年5月のガイドライン改定では、電子カルテ情報の取り扱いが厳格化されました。今後もAI技術の進化に合わせて、規制が更新されていくでしょう。
...
情報検索スキルも重要です。AIの回答を確認するため、信頼できる情報源（添付文書、診療ガイドライン、医学データベースなど）で情報を検索するスキルが必要です。PubMedの使い方、UpToDateの活用法など、医療情報源を使いこなすスキルを身につけてください。
...
AIと共存する時代だからこそ、これらの「人間にしかできないこと」を磨くことが重要です。AIに情報整理や事務作業を任せ、医療者は患者とのコミュニケーション、臨床判断、倫理的配慮といった人間にしかできない価値の高い業務に集中すべきです。
...
まず、ChatGPTは医療現場で完全に禁止されているわけではありません。ただし、2025年5月のガイドライン改定により、電子カルテ情報の取り扱いには厳格なルールが設けられています。患者の個人情報は絶対に入力してはいけません。完全に匿名化した情報、または個人情報を含まない用途（文献検索、勉強会資料作成など）であれば活用できます。
...
完全には禁止されていません。ただし、2025年5月の厚生労働省ガイドライン改定により、電子カルテ情報の取り扱いには厳格なルールが設けられています。患者の個人情報を含まない用途（文献検索、勉強会資料作成など）であれば、活用できます。
...
- 厚生労働省「医療情報システムの安全管理に関するガイドライン」Q&A（2025年5月28日改定）
